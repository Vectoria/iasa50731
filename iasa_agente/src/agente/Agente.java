...
public class Agente {
    //os atributos correspondem a associação do ambiente ao agente, e a composição do controlo ao agente
    private Ambiente ambiente;
    private Controlo controlo;

    //inicialização destes atributos
    ...
    //classe responsável por fazer o agente ter uma percepção
    ...
    //classe responsavel para o agente efetuar uma ação
    protected void actuar(Accao accao) {
        //verificasse se a ação existe
        if (accao != null) {
            //com a ação, é possivel ter um comando
            //com o comando, deduzimos o uso da variável ambiente, juntamente com a função que tem como parametro, o tipo Comando
